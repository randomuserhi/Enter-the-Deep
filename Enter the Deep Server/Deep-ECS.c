...
void Deep_ECS_Create(Deep_ECS* ECS)
{
	...
	Deep_UnorderedMap_Create(raw, raw)(&ECS->components, sizeof(Deep_ECS_Handle), Deep$AlignOf(Deep_ECS_Handle), sizeof(Deep_ECS_Archetype*), Deep$AlignOf(Deep_ECS_Archetype*));
}